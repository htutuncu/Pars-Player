...
class Dependencies {
    static func setup() {
        ...
        container.registerSingleton(ChannelsViewModel.self) { _ in ChannelsViewModel() }
...
extension Container {
    @discardableResult
    func registerSingleton<Service>(_ serviceType: Service.Type, name: String? = nil, factory: @escaping (Resolver) -> Service) -> ServiceEntry<Service> {
